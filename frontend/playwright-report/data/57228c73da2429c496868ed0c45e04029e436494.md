...
- img
- button "New fileNode File Node • source sample.json Load File Ready to Load Output file data structuredData":
  - img
  - text: New fileNode File Node • source
  - button "Run workflow from this node":
    - img
  ...
  - text: Load File
  - img
  - text: Ready to Load structuredData
...
- link "React Flow attribution":
  ...
  - text: React Flow
- img
- heading "File Node" [level=2]
- paragraph: Load data from files or save data to files
- button:
  - img
- heading "Operation Mode" [level=3]
- button "Load from File (Source) Read data from files and output structured data":
  - img
  - text: Load from File (Source)
  - paragraph: Read data from files and output structured data
- button "Save to File (Sink) Save input data to files in various formats":
  - img
  - text: Save to File (Sink)
  - paragraph: Save input data to files in various formats
- heading "File Selection" [level=3]
- img
- img
- text: Select File
- img
- text: "Current file: sample.json"
- heading "File Options" [level=4]
- text: Max Rows (optional)
- spinbutton
- text: Skip Rows
- spinbutton: "0"
