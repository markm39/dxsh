  ...
  private async executeLinearRegression(nodeId: string, nodeData: WorkflowNodeData, inputs: NodeOutput[]): Promise<any> {
    ...
    try {
      ...
      console.log('✅ Linear regression training completed:', {
        ...
        metrics: result.model.training_metrics,
        features: result.model.feature_names,
        target: result.model.target_name
      });
      ...
      return {
        ...
        r_squared: result.model.training_metrics?.test_r2,
        coefficients: result.model.coefficients,
        training_data: Array.from({ length: result.model.n_samples }, (_, i) => ({ sample: i })), // Placeholder for sample count
        ...
        summary: {
          ...
          features: result.model.feature_names,
          target: result.model.target_name,
          samplesUsed: result.model.n_samples,
          r2Score: result.model.training_metrics?.test_r2,
          mse: result.model.training_metrics?.test_mse,
          mae: result.model.training_metrics?.test_mae
        }
      };
  ...
  private async executeRandomForest(nodeId: string, nodeData: WorkflowNodeData, inputs: NodeOutput[]): Promise<any> {
    ...
    try {
      ...
      console.log('✅ Random Forest training completed:', {
        ...
        features: result.model.feature_names,
        target: result.model.target_name,
        nEstimators: result.model.n_estimators
      });
